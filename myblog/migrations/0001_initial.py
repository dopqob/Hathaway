# Generated by Django 2.1.4 on 2018-12-29 10:11
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reply', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='myblog.Comment', verbose_name='回复')),
            ],
            options={
                'verbose_name': '评论',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('alias', models.CharField(max_length=20, unique=True, verbose_name='别名')),
            ],
            options={
                'verbose_name': '标签',
        ...
        migrations.AddField(
            model_name='article',
            name='category',
            field=models.ForeignKey(default=1, on_delete=django.db.models.deletion.SET_DEFAULT, to='myblog.Category', verbose_name='类别'),
        ),
        migrations.AddField(
            model_name='article',
            name='tag',
